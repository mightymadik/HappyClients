...
final class DatabaseManager {
    ...
    public func insert(
        ...
        let data: [String: Any] = [
            "id": adPost.identifier,
            "title": adPost.title,
            "body": adPost.text,
            "created": adPost.timestamp,
            "headerImageUrl": adPost.headerImageUrl?.absoluteString ?? ""
        ]
    ...
    public func getAllPosts(
        completion: @escaping ([AdPost]) -> Void
    ) {
        database
            .collection("users")
    ...
    public func getPosts(
        ...
        database
            ...
            .getDocuments { snapshot, error in
                ...
                let posts: [AdPost] = documents.compactMap({ dictionary in
